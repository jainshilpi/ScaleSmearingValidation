...
#process.GlobalTag = GlobalTag(process.GlobalTag, '102X_upgrade2018_realistic_v12', '') #2018ABC ---> old MC, not UL
process.GlobalTag = GlobalTag(process.GlobalTag, '106X_upgrade2018_realistic_v4', '') #2018ABC
...
process.source = cms.Source("PoolSource",
        ...
        #'/store/data/Run2018D/EGamma/AOD/PromptReco-v2/000/325/170/00000/F7E3E79C-2C18-834D-86D5-C45D0F71996D.root'
                                ...
                                '/store/mc/RunIIAutumn18MiniAOD/DYToEE_M-50_NNPDF31_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/00000/3C5A5AA9-3E57-F44C-B437-10F560C9F03D.root'
        #'file:out.root'
        #'file:out_new.root'
...
#process.load("ggAnalysis.ggNtuplizer.regressionApplication2018_cff")
